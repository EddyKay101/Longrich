...
$query = "UPDATE testimonials SET title='$title', entry_text='$entry' WHERE entry_id='$id'";
$result = $conn->query($query);
if (!$result) die ("Database access failed: " . $conn->error);
...
<!DOCTYPE html>
	...
	<div id="wrapper">
			...
			<form action="testimonial-edit.php" enctype="multipart/form-data" name="myForm" id="myForm" method="post">
