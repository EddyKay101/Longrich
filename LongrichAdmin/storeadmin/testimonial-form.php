...
$entrytext =$conn->real_escape_string($_POST['entry_text']);
...
$result = $conn->query($query);
if (!$result) die ("Database access failed: " . $conn->error);
$entryMatch = $result->num_rows;
if($entryMatch > 0){
echo'Sorry you tried to place a duplicate into the system,<a href="entries-testimonials.php">click here</a>';
exit();
}
//Insert this product into the database
$query = "INSERT INTO testimonials(title,entry_text,date_created) VALUES('$title','$entrytext',now())";
$result = $conn->query( $query );
$pid = $conn->insert_id;
if ( !$result )die( "Database access failed: " . $conn->error );
...
?>
	...
	<head>
		...
		<title>Longrich | Testimonial Form</title>
	...
	<div id="wrapper">
				...
				<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-lg-10">
					  ...
					  <ol class="breadcrumb">
							...
							<li> <a>Entries</a></li>
							<li class="active"> <strong>Manage Testimonials</strong></li>
					  </ol>
					</div>
					<div class="col-lg-2">
			...
			<form action="testimonial-form.php" enctype="multipart/form-data" name="myForm" id="myForm" method="post">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <fieldset class="form-horizontal">
                                            <div class="form-group"><label class="col-sm-2 control-label">Title:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" placeholder="Title" name="title" required></div>
                                            </div>
                                         ...
                                         <input type="submit" name="submit" style="margin-left:17%;" value="Save Entry" class="btn btn-primary">
