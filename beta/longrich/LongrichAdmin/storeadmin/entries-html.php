...
if(isset($_GET['yesdelete'])){
	...
	header("location: entries-html.php");
	exit();	
}
?>
	<!DOCTYPE html>
	...
	<head>
		...
		<title>Longrich | Blog Entries</title>
				...
				<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-lg-10">
					  ...
					  <ol class="breadcrumb">
							...
							<li> <a>Entries</a></li>
							<li class="active"> <strong>Blog Entries</strong></li>
					  </ol>
					</div>
					<div class="col-lg-2">
	...
	//read dir
		...
		while($row = $result->fetch_array(MYSQLI_ASSOC)){
			...
			<div class='btn-group'>
			<a href='blog-edit.php?id=$id' class='btn-white btn btn-xs'>view</a>
			<a href='blog-edit.php?id=$id' class='btn-white btn btn-xs'>edit</a> 
			<a href='entries-html.php?deleteid=$id' class='btn-white btn btn-xs'>delete</a><br></div></form>";
...
if (isset($_GET['deleteid'])) {
	echo '<p>Do you really want to delete this entry ? <a href="entries-html.php?yesdelete=' . $_GET['deleteid'] . '">Yes</a> | <a href="entries-html.php">No</a></p>';
	exit();
}
?>
